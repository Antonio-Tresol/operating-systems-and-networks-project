...
SemTable *semaphoreTable;

map<int, Socket> *socketTable;
...
// 2007, Jose Miguel Santos Espino
    ...
    memoryLock = new Lock("Main Memory");
    memoryManager = new MemoryManager();

    semaphoreTable = new SemTable();

    socketTable = new map<int, Socket>();

    processTable = new ProcessTable(128);
    syscallLock = new Lock("Syscall");
#endif
#ifdef FILESYS_NEEDED
